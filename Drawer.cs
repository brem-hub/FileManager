...
namespace FileManager
{
     ...
     *    
     *     Модуль Thread(https://docs.microsoft.com/ru-ru/dotnet/api/system.threading.thread?view=netcore-3.1)
     *                    для "задержки времени" для прикольного эффекта, а точнее его метод Thread.Sleep(ms)
     *                    Этот метод ждёт нужное количество ms и возвращает контроль в метод, который его вызвал.
    */
    ...
    class Drawer
    {
        ...
        // Redundant
        /// <summary>
        ///     Method converts dictionary to list
        /// </summary>
        /// <param name="data"> Dictionary of Lists and strings</param>
        /// <returns></returns>
        //private List<string> ConvertDictToList(Dictionary<List<int>, ValueTuple<int, int>> data)
        //{
        //    List<string> strings = new List<string>(data.Count);
        //    foreach (KeyValuePair<List<int>, ValueTuple<int, int>> entry in data)
        //    {
        //        strings.Add(ListToString(entry.Key) + " ---> " + _language.Bulls() + " " + entry.Value.Item1.ToString() + " / " + _language.Cows() + " " + entry.Value.Item2.ToString());
        //    }
        //    return strings;
        //}
        ...
        //  !!! They don't calculate anything for the game, just output the data!!!
        ...
        //public void DrawInstruction(int n)
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines(5, _language.Instruction(n));
        //    data.Add(1, _language.InstructionTitle());
        //    DrawSector(data: data);
        //}
        //public void DrawGetSize()
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines((int)(uint)Sizes.AppHeight / 2, _language.GetSize());
        //    drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);

        //}
        //public void DrawGame(int len, int maxMoves, Dictionary<List<int>, ValueTuple<int, int>> prevMoves = null, int move = 1, bool exitData = false)
        //{
        //    Console.Clear();
        //    string stepInfo = _language.MoveInfo() + " " + move + " / " + maxMoves;
        //    string infoWriteNewNumber = _language.NewNumber() + len;

        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines(1, new string[] { stepInfo });

        //    if (exitData)
        //    {
        //        string[] exitInfo = _language.GameExitInfo();
        //        data.Add(2, exitInfo[0]);
        //        data.Add(3, exitInfo[1]);
        //    }
        //    if (prevMoves == null)
        //    {
        //        data.Add((int)(uint)Sizes.AppHeight / 2, infoWriteNewNumber);
        //        drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);
        //    }
        //    else
        //    {
        //        int startingPoint = 3;
        //        List<string> strings = ConvertDictToList(prevMoves);
        //        int lastPos = 0;
        //        for (int i = 0; i < prevMoves.Count; i++)
        //        {
        //            data.Add(startingPoint + i + 5, strings[i]);
        //            if (i == prevMoves.Count - 1)
        //                lastPos = startingPoint + i + 5;
        //        }
        //        if (lastPos >= (uint)Sizes.AppHeight)
        //            drawSector((uint)lastPos + 1, (uint)Sizes.AppWidth, data);
        //        else
        //            drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);
        //    }
        //}

        //public void DrawWin(int n)
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines((int)(uint)Sizes.AppHeight / 2, _language.Win(n));
        //    drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);
        //}

        //public void DrawLoseEndedSteps(List<int> number)
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines((int)(uint)Sizes.AppHeight / 2, _language.LoseStepsEnded(number));
        //    drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);
        //}
        //public void DrawErrorInputNumber(int n)
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines((int)(uint)Sizes.AppHeight / 2, _language.ErrorInputNumber(n));
        //    drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);

        //}
        //public void DrawErrorSizeNumber()
        //{
        //    Console.Clear();
        //    SortedDictionary<int, string> data = GenerateDictionaryOfDataLines((int)(uint)Sizes.AppHeight / 2, _language.ErrorSizeNumber());
        //    drawSector((uint)Sizes.AppHeight, (uint)Sizes.AppWidth, data);
        //}
    }
}
